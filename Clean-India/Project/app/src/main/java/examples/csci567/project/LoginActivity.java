...
// Code used from Bryan Dixon's Lecture
...
public class LoginActivity extends FragmentActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
   ...
   //private Button signOutButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseRef = new Firebase("https://pinak-cleanindia.firebaseio.com/");
                            ...
                            public void run() {
                                if (e instanceof UserRecoverableAuthException) {
                                    ...
                                    Toast.makeText(getApplicationContext(), "Signed Up Successfully! " +
                                            "Please Click the Sign In button now to login",
                            ...
                            mFirebaseRef.authWithOAuthToken("google",token , new Firebase.AuthResultHandler() {
                                ...
                                public void onAuthenticated(AuthData authData) {
                                    ...
                                    * */
                                    ...
                                    user.setDisplayName(mAuthData.getProviderData().get("displayName").toString());
                                    user.setProvider(mAuthData.getProvider().toString());
                                    user.setuId(mAuthData.getUid());
                                    mFirebaseRef.child("users").child(mAuthData.getUid()).setValue(user);
